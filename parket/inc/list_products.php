<div id="featured_products">
        ...
        <?php 
        $product_result = run_q('SELECT * FROM products WHERE is_public=1 AND group_id='.$group.' ORDER BY product_id DESC');
        $i = 1;
        ...
        if(mysql_num_rows($product_result) == 0){
            echo '<h3 style="margin: 150px 0 200px 100px; color:gray;">В тази категолия няма добавени продукти!</h3>';
        }
        ?>
